...
| TUI components / screens | `src/tui/` — follow the architecture guidelines in `src/tui/architecture.md` and the component organization conventions in `src/tui/CLAUDE.md` |
...
skills/                       # Agent Skills (progressive disclosure docs)
  ...
  providers/
    ...
    filesystem/SKILL.md       # Filesystem issue files
